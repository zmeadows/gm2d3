    ...
    Fl_Double_Window(w, h, t)
{
    ...
    auto_control = std::unique_ptr<GM2D3AutoControlGUI>
        (new GM2D3AutoControlGUI(400 + WINDOW_EDGE_GAP + ADJACENT_SPACING, WINDOW_EDGE_GAP, 400, 130));

    options = std::unique_ptr<GM2D3OptionsGUI>
        (new GM2D3OptionsGUI(800 + WINDOW_EDGE_GAP + 2*ADJACENT_SPACING, WINDOW_EDGE_GAP, 250, 130));
