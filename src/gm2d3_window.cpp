    ...
    Fl_Double_Window(w, h, t)
{
    {Fl_Pack *vertical_pack = new Fl_Pack(45,30,750,870);
        ...
        ad = new GM2D3StageDiagnostics(0,40,w,100,"Azimuthal Stage History");
        vd = new GM2D3StageDiagnostics(0,50,w,100,"Vertical Stage History");
        rd = new GM2D3StageDiagnostics(0,60,w,100,"Radial Stage History");
        vertical_pack->end();
    }
    end();
}
